...
function swapPicture() {
  let deadMonster = document.querySelector(".enemy1") //finds original image, see line 100
  ...
  if (mirrorMonster.health == 0) {
    deadMonster.classList.replace('enemy1', "enemyDead") //replaces images from line 94
